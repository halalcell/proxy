function FindProxyForURL(url, host) {
	...
	//FROM RULE: BLOCK:dnsDomainIs(host,"img-s-msn-com.akamaized.com")
	if(dnsDomainIs(host,"img-s-msn-com.akamaized.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BLOCK:dnsDomainIs(host,"assets.msn.com")
	if(dnsDomainIs(host,"assets.msn.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BLOCK:dnsDomainIs(host,"c.msn.com")
	if(dnsDomainIs(host,"c.msn.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BLOCK:dnsDomainIs(host,"api.msn.com")
	if(dnsDomainIs(host,"api.msn.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BLOCK:dnsDomainIs(host,"www.msn.com")
	if(dnsDomainIs(host,"www.msn.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BLOCK:dnsDomainIs(host,"srtb.msn.com")
	if(dnsDomainIs(host,"srtb.msn.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BLOCK:dnsDomainIs(host,"img.s-msn.com")
	if(dnsDomainIs(host,"img.s-msn.com")) return "PROXY 0.0.0.0:1234";

	//FROM RULE: BYPASS:dnsDomainIs(host,"teams.microsoft.com")
	if(dnsDomainIs(host,"teams.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"teams.skype.com")
	if(dnsDomainIs(host,"teams.skype.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"teams.microsoft.us")
	if(dnsDomainIs(host,"teams.microsoft.us")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"us-api.asm.skype.com")
	if(dnsDomainIs(host,"us-api.asm.skype.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"urlp.sfbassets.com")
	if(dnsDomainIs(host,"urlp.sfbassets.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"api.microsoftstream.com")
	if(dnsDomainIs(host,"api.microsoftstream.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"prdeuscompsvc.keydelivery.eastus.media.azure.net")
	if(dnsDomainIs(host,"prdeuscompsvc.keydelivery.eastus.media.azure.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"microsoftstream.com")
	if(dnsDomainIs(host,"microsoftstream.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"secure.aadcdn.microsoftonline-p.com")
	if(dnsDomainIs(host,"secure.aadcdn.microsoftonline-p.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"statics.teams.cdn.office.net")
	if(dnsDomainIs(host,"statics.teams.cdn.office.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"assets.onestore.ms")
	if(dnsDomainIs(host,"assets.onestore.ms")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"amp.azure.net")
	if(dnsDomainIs(host,"amp.azure.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"c.s-microsoft.com")
	if(dnsDomainIs(host,"c.s-microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"media.azure.net")
	if(dnsDomainIs(host,"media.azure.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"endpoint1-g01prdeuscompsvc-usea.streaming.media.azure.net")
	if(dnsDomainIs(host,"endpoint1-g01prdeuscompsvc-usea.streaming.media.azure.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"aadcdn.msauth.net")
	if(dnsDomainIs(host,"aadcdn.msauth.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"aadcdn.msftauth.net")
	if(dnsDomainIs(host,"aadcdn.msftauth.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"whiteboard.microsoft.com")
	if(dnsDomainIs(host,"whiteboard.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"logincdn.msauth.net")
	if(dnsDomainIs(host,"logincdn.msauth.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"aadcdn.msauthimages.net")
	if(dnsDomainIs(host,"aadcdn.msauthimages.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"web.microsoftstream.com")
	if(dnsDomainIs(host,"web.microsoftstream.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"mbankhost.com")
	if(dnsDomainIs(host,"mbankhost.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"mb.mbankhost.com")
	if(dnsDomainIs(host,"mb.mbankhost.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"api.appcelerator.com")
	if(dnsDomainIs(host,"api.appcelerator.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"pnc.com")
	if(dnsDomainIs(host,"pnc.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"pncmc.com")
	if(dnsDomainIs(host,"pncmc.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"gz0googleusercontent.com")
	if(dnsDomainIs(host,"gz0googleusercontent.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"gz.gstatic.com")
	if(dnsDomainIs(host,"gz.gstatic.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"mobilemaps.googleapis.com")
	if(dnsDomainIs(host,"mobilemaps.googleapis.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"translate.google.com")
	if(dnsDomainIs(host,"translate.google.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"reverso.net")
	if(dnsDomainIs(host,"reverso.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"weather-data.apple.com")
	if(dnsDomainIs(host,"weather-data.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"weather-edge.com weather-analytics-event.apple.com")
	if(dnsDomainIs(host,"weather-edge.com weather-analytics-event.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"classroom.google.com")
	if(dnsDomainIs(host,"classroom.google.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"onenote.com")
	if(dnsDomainIs(host,"onenote.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"onenote.net")
	if(dnsDomainIs(host,"onenote.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ensighten.com")
	if(dnsDomainIs(host,"ensighten.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"aspnetcdn.com")
	if(dnsDomainIs(host,"aspnetcdn.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"microsoft.com")
	if(dnsDomainIs(host,"microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"live.com")
	if(dnsDomainIs(host,"live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"optimizely.com")
	if(dnsDomainIs(host,"optimizely.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"microsoftonline.com")
	if(dnsDomainIs(host,"microsoftonline.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"msecnd.net")
	if(dnsDomainIs(host,"msecnd.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"skype.com")
	if(dnsDomainIs(host,"skype.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"sfx.ms")
	if(dnsDomainIs(host,"sfx.ms")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host,"rlcdn.com")
	if(dnsDomainIs(host,"rlcdn.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"s.paypal.com")
	if(dnsDomainIs(host,"s.paypal.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"mediaplex.com")
	if(dnsDomainIs(host,"mediaplex.com")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host,"kampyle.com")
	if(dnsDomainIs(host,"kampyle.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"arkoselabs.com")
	if(dnsDomainIs(host,"arkoselabs.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"usbla.net")
	if(dnsDomainIs(host,"usbla.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"apptentive.com")
	if(dnsDomainIs(host,"apptentive.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"idp.iamfas.belgium.be")
	if(dnsDomainIs(host,"idp.iamfas.belgium.be")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"paypal.me")
	if(dnsDomainIs(host,"paypal.me")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ketabonline.com")
	if(dnsDomainIs(host,"ketabonline.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"venmo.com")
	if(dnsDomainIs(host,"venmo.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"paypalobjects.com.akadns.net")
	if(dnsDomainIs(host,"paypalobjects.com.akadns.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"paypalobjects.com.edgekey.net")
	if(dnsDomainIs(host,"paypalobjects.com.edgekey.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"kvenmopics.appspot.com")
	if(dnsDomainIs(host,"kvenmopics.appspot.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"venmo.zendesk.com")
	if(dnsDomainIs(host,"venmo.zendesk.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"c.microsoft.com")
	if(dnsDomainIs(host,"c.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"c1.microsoft.com")
	if(dnsDomainIs(host,"c1.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"cdn.odc.officeapps.live.com")
	if(dnsDomainIs(host,"cdn.odc.officeapps.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"sharepoint.com")
	if(dnsDomainIs(host,"sharepoint.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"self.events.data.microsoft.com")
	if(dnsDomainIs(host,"self.events.data.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"substrate.office.com")
	if(dnsDomainIs(host,"substrate.office.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"files.guran.app")
	if(dnsDomainIs(host,"files.guran.app")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"mirrors.quranicaudio.com")
	if(dnsDomainIs(host,"mirrors.quranicaudio.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"graph.microsoft.com")
	if(dnsDomainIs(host,"graph.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"login.microsoftonline.com")
	if(dnsDomainIs(host,"login.microsoftonline.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ocws.officeapps.live.com")
	if(dnsDomainIs(host,"ocws.officeapps.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"www.onenote.com")
	if(dnsDomainIs(host,"www.onenote.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"fs.microsoft.com")
	if(dnsDomainIs(host,"fs.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"acctcdn.msftauth.net")
	if(dnsDomainIs(host,"acctcdn.msftauth.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"autodiscover-s.outlook.com")
	if(dnsDomainIs(host,"autodiscover-s.outlook.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"d.docs.live.net")
	if(dnsDomainIs(host,"d.docs.live.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"docs.live.net")
	if(dnsDomainIs(host,"docs.live.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ecs.office.com")
	if(dnsDomainIs(host,"ecs.office.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"acctedn.msauth.net")
	if(dnsDomainIs(host,"acctedn.msauth.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"login.windows.net")
	if(dnsDomainIs(host,"login.windows.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"nexusrules.officeapps.live.com")
	if(dnsDomainIs(host,"nexusrules.officeapps.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"officeclient.microsoft.com")
	if(dnsDomainIs(host,"officeclient.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ols.officeapps.live.com")
	if(dnsDomainIs(host,"ols.officeapps.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"outlook.office365.com")
	if(dnsDomainIs(host,"outlook.office365.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"roaming.officeapps.live.com")
	if(dnsDomainIs(host,"roaming.officeapps.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"support.content.office.net")
	if(dnsDomainIs(host,"support.content.office.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"guran.app")
	if(dnsDomainIs(host,"guran.app")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"quran.app")
	if(dnsDomainIs(host,"quran.app")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"quranicaudio.com")
	if(dnsDomainIs(host,"quranicaudio.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"masjidal.com")
	if(dnsDomainIs(host,"masjidal.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"islamicbulletin.org")
	if(dnsDomainIs(host,"islamicbulletin.org")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"edge.mixlr.com")
	if(dnsDomainIs(host,"edge.mixlr.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"masjidal.s3.us-east-2.amazonaws.com")
	if(dnsDomainIs(host,"masjidal.s3.us-east-2.amazonaws.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"radiojar.com")
	if(dnsDomainIs(host,"radiojar.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"italki.com")
	if(dnsDomainIs(host,"italki.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"api.italki.com.cn")
	if(dnsDomainIs(host,"api.italki.com.cn")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"tracking-api.ialki.com")
	if(dnsDomainIs(host,"tracking-api.ialki.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"italki.cn")
	if(dnsDomainIs(host,"italki.cn")) return "DIRECT";

	//FROM RULE: BYPASS:isInNet(dnsResolve(host),"104.7.66.64","255.255.255.0")
	if(isInNet(dnsResolve(host),"104.7.66.64","255.255.255.0")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"onedrive.live.com")
	if(dnsDomainIs(host,"onedrive.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"onedrive.com")
	if(dnsDomainIs(host,"onedrive.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"officeapps.live.com")
	if(dnsDomainIs(host,"officeapps.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"auth.gfx.ms")
	if(dnsDomainIs(host,"auth.gfx.ms")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"skyapi.live.net")
	if(dnsDomainIs(host,"skyapi.live.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"api.onedrive.com")
	if(dnsDomainIs(host,"api.onedrive.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"storage.live.com")
	if(dnsDomainIs(host,"storage.live.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"drv.com")
	if(dnsDomainIs(host,"drv.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"livefilestore.com")
	if(dnsDomainIs(host,"livefilestore.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"1drv.com")
	if(dnsDomainIs(host,"1drv.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"office365.com")
	if(dnsDomainIs(host,"office365.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"eastus1-mediap.svc.ms")
	if(dnsDomainIs(host,"eastus1-mediap.svc.ms")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"eastus3-sphomep.svc.ms")
	if(dnsDomainIs(host,"eastus3-sphomep.svc.ms")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"office15client.microsoft.com")
	if(dnsDomainIs(host,"office15client.microsoft.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"receiver.lcoe.oath.com")
	if(dnsDomainIs(host,"receiver.lcoe.oath.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ims-na1.adobelogin.com")
	if(dnsDomainIs(host,"ims-na1.adobelogin.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"webshell.suite.office.com")
	if(dnsDomainIs(host,"webshell.suite.office.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"oki.delve.office.com")
	if(dnsDomainIs(host,"oki.delve.office.com")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "pm.gentechsolution.com")
	if(dnsDomainIs(host, "pm.gentechsolution.com")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "c*.googleusercontent.com")
	if(dnsDomainIs(host, "c*.googleusercontent.com")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "weather-edge.apple.com")
	if(dnsDomainIs(host, "weather-edge.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "weather-analytics-events.apple.com")
	if(dnsDomainIs(host, "weather-analytics-events.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "gsp-ssl.ls.apple.com")
	if(dnsDomainIs(host, "gsp-ssl.ls.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "weather-map2.apple.com")
	if(dnsDomainIs(host, "weather-map2.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "play.itunes.apple.com")
	if(dnsDomainIs(host, "play.itunes.apple.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"s.mzstatic.com")
	if(dnsDomainIs(host,"s.mzstatic.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"proton.me")
	if(dnsDomainIs(host,"proton.me")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "adclient-downloads.smartlistlocal.com")
	if(dnsDomainIs(host, "adclient-downloads.smartlistlocal.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "api.smartlistlocai.com")
	if(dnsDomainIs(host, "api.smartlistlocai.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "lionscribe.com")
	if(dnsDomainIs(host, "lionscribe.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "smartlist.us")
	if(dnsDomainIs(host, "smartlist.us")) return "DIRECT";
	...
	//FROM RULE: BYPASS:shExpMatch(host, "api.koshergps.myjewishlistings.com")
	if(shExpMatch(host, "api.koshergps.myjewishlistings.com")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "media2.93fm.co.il")
	if(dnsDomainIs(host, "media2.93fm.co.il")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "code.jquery.com")
	if(dnsDomainIs(host, "code.jquery.com")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host, "mobilemaps-pa-gz.googleapis.com")
	if(dnsDomainIs(host, "mobilemaps-pa-gz.googleapis.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "streetviewpixels-pa.googleapis.com")
	if(dnsDomainIs(host, "streetviewpixels-pa.googleapis.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "24six.app")
	if(dnsDomainIs(host, "24six.app")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "stream.mux.com")
	if(dnsDomainIs(host, "stream.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "manifest-gce-us-east1-production.fastly.mux.com")
	if(dnsDomainIs(host, "manifest-gce-us-east1-production.fastly.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "o1300774.ingest.sentry.io")
	if(dnsDomainIs(host, "o1300774.ingest.sentry.io")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "chunk-gcp-us-east1-vop1.fastly.mux.com")
	if(dnsDomainIs(host, "chunk-gcp-us-east1-vop1.fastly.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "manifest-gcp-us-east1-vop1.fastly.mux.com")
	if(dnsDomainIs(host, "manifest-gcp-us-east1-vop1.fastly.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"usestoryteller.com")
	if(dnsDomainIs(host,"usestoryteller.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"9nf43v5wte-dsn.algolia.net")
	if(dnsDomainIs(host,"9nf43v5wte-dsn.algolia.net")) return "DIRECT";
	...
	//FROM RULE: BYPASS:dnsDomainIs(host,"api.usestoryteller.com")
	if(dnsDomainIs(host,"api.usestoryteller.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"chunk-gce-us-east4-production.cfcdn.mux.com")
	if(dnsDomainIs(host,"chunk-gce-us-east4-production.cfcdn.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"manifest-gce-us-east4-production.cfcdn.mux.com")
	if(dnsDomainIs(host,"manifest-gce-us-east4-production.cfcdn.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"chunk-gcp-us-east1-vop1.cfcdn.mux.com")
	if(dnsDomainIs(host,"chunk-gcp-us-east1-vop1.cfcdn.mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "sentry.io")
	if(dnsDomainIs(host, "sentry.io")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host, "mux.com")
	if(dnsDomainIs(host, "mux.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"herokuapp.com")
	if(dnsDomainIs(host,"herokuapp.com")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"ota-cache1.googlezip.net")
	if(dnsDomainIs(host,"ota-cache1.googlezip.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"meaningfulminute.org")
	if(dnsDomainIs(host,"meaningfulminute.org")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"dcypdyud4mfq7.cloudfront.net")
	if(dnsDomainIs(host,"dcypdyud4mfq7.cloudfront.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"do95wry26kkqo.cloudfront.net")
	if(dnsDomainIs(host,"do95wry26kkqo.cloudfront.net")) return "DIRECT";

	//FROM RULE: BYPASS:dnsDomainIs(host,"o939356.ingest.sentry.io")
	if(dnsDomainIs(host,"o939356.ingest.sentry.io")) return "DIRECT";

	//FROM RULE: PROXY:true
	if(true) return "PROXY localhost:50222;";
